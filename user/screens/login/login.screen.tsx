...
export default function LoginScreen() {
  ...
  const handleSuccessfulLogin = useCallback(async (user: any) => {
    try {
      ...
      let errorMessage = "Unable to sign in with Google right now.";
      ...
      if (error.code === 'ECONNABORTED' || error.message?.includes('timeout')) {
        ...
        errorMessage = "Cannot connect to server. Please check if the server is running and the IP address is correct.";
