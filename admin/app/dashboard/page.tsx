...
type ReviewDecision = "approved" | "declined" | "blocked" | "reinstate" | "delete";
...
export default function DashboardPage() {
  ...
  const handleDecision = async (
    ...
    try {
      // Handle delete separately (DELETE request)
      if (decision === "delete") {
        ...
        setFeedback("Driver deleted successfully. All credentials have been removed from the database.");
      } else {
        // Handle other decisions (PATCH request)
